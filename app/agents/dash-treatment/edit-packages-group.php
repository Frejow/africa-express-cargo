...
if (isset($_POST['withdraw_package_ingroup']) && !empty($_POST['withdraw_package_ingroup'])) {
    ...
    if (unlinkSpecificPackagesGroupOfPackage(explode('&',$_POST['withdraw_package_ingroup'])[1], explode('&',$_POST['withdraw_package_ingroup'])[0])) {
...
if (isset($_POST['withdraw_allpackages_ingroup']) && !empty($_POST['withdraw_allpackages_ingroup'])) {
    ...
    if (unlinkSpecificPackagesGroupOfAllPackages($_POST['withdraw_allpackages_ingroup'])) {
