                            ...
                            <div class="mb-3 ">
                                ...
                                <div class="">
                                    <select class="form-select select2bs4" id="selection" onchange="updateBlockVisibility()" name="customerSelect" data-placeholder="Laissez ce champs vide s'il s'agit d'un colis sans destinataire" style="width: 100%;">
                                        ...
                                        ?>
                                                <option <?php echo (!empty($updata["customerSelect"]) && $updata["customerSelect"] == $value['id'] . '&' . $value['user_name']) ? "selected" : "" ?> value="<?= $value['id'] . '&' . $value['user_name'] ?>"><?= $value['name'] . ' ' . $value['first_names'] ?></option>
                                ...
                                <?php
                                if (isset($error["customerSelect"]) && !empty($error["customerSelect"])) {
