                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex">
                            <div>
                                <a href="<?= redirect($_SESSION['theme'], PROJECT.'agents/dash/customers-packages-group-listings') ?>" class="btn btn-link link-secondary" style="border:none; width:fit-content;">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-flat">
                                            <input type="number" class="form-control" value="" placeholder="0" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="card-footer d-flex">
                            <a href="<?= redirect($_SESSION['theme'], PROJECT.'agents/dash/customers-packages-group-listings') ?>" class="btn btn-link link-secondary" style="border:none;">
                                Annuler
                            </a>
