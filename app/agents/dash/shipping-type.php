...
//Premier paramètre, le nom de la table en base de données à lister. Table "shipping_type" pour le cas présent
$table = "shipping_type";
...
//Troisième paramètre, nombre de type d'envoi à afficher par page. 10 par défaut
...
// Cinquième paramètre, le nom du type d'envoi à rechercher. "UNDEFINED" par défaut dans le cas où aucune recherche n'est lancée
...
/**
 * Nouvelle valeur du troisième paramètre, nombre de type d'envoi par page, lorsqu'un autre nombre autre que 10 est sélectionné 
 * par l'utilisateur poiur afficher le nombre de type d'envoi par page
 */
...
//Nouvelle valeur du cinquième paramètre, le type d'envoi à rechercher dans la table "shipping_type"
if (isset($_SESSION['research']) && !empty($_SESSION['research'])) {
    $_SESSION['search'] = $_SESSION['research'];
}

//die(var_dump($_SESSION['shipping_listings']));

//Affectation du retour de la fonction othListings avec les six paramètres suscités à la variable $shipping_listings
$shipping_listings = othListings($table, $_SESSION['page'], $_SESSION['rows_per_page'], ucfirst($_SESSION['search']), $_SESSION['research_by'], $_SESSION['order']);
...
<form id="myForm" action="<?= redirect($_SESSION['theme'], PROJECT . 'agents/dash-treatment/shipping-type') ?>" method="post">
            ...
            <div class="row g-2 align-items-center " style="flex-wrap: wrap;">
                ...
                <div class="col-12 col-lg-auto ms-auto d-print-none">
                    <div class="btn-list justify-content-center">
                        <a href="<?= redirect($_SESSION['theme'], PROJECT . 'agents/dash/set-shipping-type') ?>" class="btn d-none text-white d-sm-inline-block btn-warning">
                        ...
                        <a href="<?= redirect($_SESSION['theme'], PROJECT . 'agents/dash/set-shipping-type') ?>" class="btn d-sm-none text-white btn-warning">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path d="M12 5l0 14" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs mb-2 text-muted ms-auto" style="display: flex;">
                                    ...
                                    <div class="ms-2 d-inline-block">
                                        <input type="text" name="search" class="form-control" value="<?= isset($_SESSION['research']) ? $_SESSION['research'] : '' ?>" placeholder="Type d'envoi">
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap">
                                ...
                                <tbody class="text-center">
                                    <?php
                                    if (isset($shipping_listings) && !empty($shipping_listings)) {
                                        ...
                                        foreach ($shipping_listings as $key => $shipping) {
                                    ?>
                                            <tr>
                                                <td>
                                                    <?php
                                                ...
                                                <td>
                                                    <?= !empty($shipping['name']) ? $shipping['name'] : '' ?>
                                                </td>
                                                <td class="">
                                                    <?= !empty($shipping['delivery_time']) ? $shipping['delivery_time'] : '-'  ?>
                                                </td>
                                                <td class="text-end">
                                                    <span class="">
                        ...
                        <div class="table-responsive card-footer d-flex align-items-center">
                            ...
                            ?>
                                ...
                                <p class="m-0 text-muted">
                                    Affichage
                                    <?php if (isset($shipping_listings) && !empty($shipping_listings)) {
                                    ?>
                                        de la ligne
                                    <?php
                                    }
                            ...
                            <ul class="pagination m-0 ms-auto">
                                ...
                                <li class="page-item <?php if (!isset($shipping_listings) || empty($shipping_listings)) {
                                                            echo 'disabled';
                                                        } ?>">
