    ...
    <div class="modal modal-blur fade" id="modal-packages-group-detail" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                                    ...
                                    <table class="table card-table table-vcenter text-nowrap datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <span class="">
                                                        <a class="btn-link" href="" data-bs-toggle="modal" data-bs-dismiss="false" data-bs-target="#modal-packages-ingroup-detail">
                                                            Détails
                                                        </a>
                                                    </span>
                                                </td>
    ...
    <script>
        ...
        const packgrpBtn = document.getElementById('packgrp_btn');
        const addgrpBtn = document.getElementById('addgrp_btn');
        ...
        function displayBox() {
            for (let i = 0; i < rowChecks.length; i++) {
                rowChecks[i].style.display = 'inline-block';
            }
            packgrpBtn.style.display = 'none';
            addgrpBtn.style.display = 'inline-block';
            instruction.style.display = 'block';
        }

        packgrpBtn.addEventListener('click', displayBox);

        checkAll.addEventListener('click', function() {
            for (let i = 0; i < rowChecks.length; i++) {
                rowChecks[i].checked = this.checked;
            }
        });
        ...
        for (let i = 0; i < checkboxes.length; i++) {
            checkboxes[i].addEventListener('change', checkIfChecked);
        }
    </script>
    ...
    <script>
        $('#modal-packages-ingroup-detail').on('hidden.bs.modal', function () {
