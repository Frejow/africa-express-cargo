...
<form id="myForm" action="<?= redirect($_SESSION['theme'], PROJECT . 'customer/dash-treatment/shipping-type') ?>" method="post">
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap">
                                ...
                                <tbody class="text-center">
                                    ...
                                    ?>
                                            <tr class="<?php echo (!empty($shipping['is_active']) && $shipping['is_active'] == 1 ) ? '' : 'bg-danger-lt'  ?>">
                                                <td>
                                                    <?php
                                                ...
                                                <td class="">
                                                    <?php echo (!empty($shipping['is_active']) && $shipping['is_active'] == 1 ) ? 'Actif' : 'Inactif'  ?>
                                                </td>
                                            </tr>
                                        <?php
                                        }
