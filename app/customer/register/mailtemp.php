...
$url = $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].PROJECT.'customer/account-validation/index/{user_id}/{token}';
...
<body oncontextmenu='return false' class='snippet-body'>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <!-- LOGO -->
        <tr>
            <td bgcolor="#2e358b" align="center">
        ...
        <tr>
            <td bgcolor="#2e358b" align="center" style="padding: 0px 10px 0px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                            <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Bienvenue !</h1> 
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" class="valid_btn" style="border-radius: 5px;" bgcolor="#e0643a"><a
                                                        ...
                                                        style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; padding: 15px 25px; display: inline-block;">Valider mon compte</a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Si vous avez des questions, il suffit de répondre à cet e-mail, nous sommes toujours heureux de vous aider.
                                </p>
                        </td>
                    </tr>
                    <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#FFECD1" align="center"
                            ...
                            <h2 style="font-size: 20px; font-weight: 400; color: #111111; margin: 0;">Plus d'informations?
                            </h2>
