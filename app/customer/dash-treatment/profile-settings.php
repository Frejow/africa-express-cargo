...
if (isset($_POST['pass']) && !empty($_POST['pass']) && check_password($data[0]['id'], $_POST['pass'])) {
    ...
    if ($_POST['tel'] != $data[0]['phone_number']){
