...
<body>
    ...
    <form action="<?= PROJECT . 'admin/reset-password/link-expiredtreat' ?>" method="post">
        <div class="">
            ...
            <div class="modal-body text-center py-4">
                ...
                <button type="submit" class="btn btn-primary mb-3 <?= isset($_SESSION['user_id']) ? '' : 'disabled' ?>" name="resend_mail" value="<?= isset($_SESSION['user_id']) ? $_SESSION['user_id'] : '' ?>">
                    Renvoyer un nouveau mail de réinitialisation de mot de passe
                </button>
