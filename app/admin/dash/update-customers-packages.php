                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex">
                            <div>
                                <a href="<?= redirect($_SESSION['theme'], PROJECT.'admin/dash/customers-packages-listings') ?>" class="btn btn-link link-secondary" style="border:none; width:fit-content;">
                        ...
                        <div class="card-footer d-flex">
                            <a href="<?= redirect($_SESSION['theme'], PROJECT.'admin/dash/customers-packages-listings') ?>" class="btn btn-link link-secondary" style="border:none;">
                                Annuler
                            </a>
