...
if (!empty($_SESSION['admin_current_url'])) {
    $_SESSION['current_url'] = $_SESSION['admin_current_url'];
}
...
if (!empty($_SESSION["connected_admin"])) {
    $data = json_decode($_SESSION["connected_admin"], true);
} 
        ...
        if (isset($params[1]) && !empty($params[1])) {
            ...
            elseif (($params[1] != 'dash' && $params[1] != 'logout' && $params[1] != 'dash-treatment')) {
                ...
                if (!empty($_SESSION['connected_admin'])) {
                    ...
                    header("location:".$_SESSION['admin_current_url']);
