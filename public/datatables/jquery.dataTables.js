...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( selector, options )
	{
		...
		this.each(function() {
			...
			_fnCallbackReg( oSettings, 'aoCallback',     oInit.fnFooterCallback,    'user' );
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Affichage _START_ à _END_ sur _TOTAL_ ligne(s)",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Affichage 0 à 0 sur 0 ligne",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(trier sur _MAX_ ligne(s) au total)",
